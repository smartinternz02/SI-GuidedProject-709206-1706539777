...
WebUI.setText(findTestObject('Amazon/Page_Amazon.in/input_twotabsearchtextbox'), 'mobilephone')

// Press Enter key to perform the search
WebUI.sendKeys(findTestObject('Amazon/Page_Amazon.in/input_twotabsearchtextbox'), Keys.chord(Keys.ENTER))

// Wait for search results to load
WebUI.waitForElementPresent(findTestObject('Amazon/Page_Amazon.in/div_s-main-slot'), 10)

// Verify that search results are present
WebUI.verifyElementPresent(findTestObject('Amazon/Page_Amazon.in/span_s-no-results-0'), 10)
WebUI.navigateToUrl('https://www.amazon.in/')
